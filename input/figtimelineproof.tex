...
\begin{tikzpicture}[scale=1]
  ...
  -- node[below]{$\mathcal{B}_1$} (2*\X, \YA + \YSPACE);
  ...
  -- node[above]{$\mathcal{B}_1 \cup \mathcal{C}_1$}
  (3*\X, \YB - \YSPACE);
  ...
  node[below]{$\mathcal{C}_1 \cup \mathcal{B}_2$}
  (4*\X, \YA + 1* \YSPACE);
  ...
  node[above]{$\mathcal{B}_2 \cup \mathcal{C}_2$}
  (5*\X, \YB - 1*\YSPACE);
  ...
  node[below]{$\mathcal{C}_2 \cup \mathcal{B}_3$} (6*\X, \YA + 1*\YSPACE);


  \draw[->, very thick, color=yellow!90!black!100] ( 6*\X, \YA ) -- node[sloped, above]{$\bm{B_\beta}$} (7*\X, \YB);

  
  \draw[<->,very thick, color=purple!80!black!80] (5*\X, \YB - 1*\YSPACE ) -- node[below]{$\bm{B_\pi}$}
  node[above]{$\mathcal{B}_3' \cup \mathcal{C}_3$ with
